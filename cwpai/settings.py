"""
Django settings for cwpai project.
...
SECRET_KEY = 'django-insecure-i2l5=j9a9y(t+zx3qdadt&ni4sd6t05hgn^8(we&1z+20z_uek'
...
WSGI_APPLICATION = 'cwpai.wsgi.application'
